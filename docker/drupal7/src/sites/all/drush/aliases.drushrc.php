...
include_once 'aliases.utils.inc';
...
$aliases['site.dev'] = array(
  ...
  'path-aliases' => array(
    '%dump' => '/tmp/site.sql',
    '%files' => '/htdocs/site/sites/site.dev/files',
  ),
  'uri' => 'site.dev',
  'databases' => site_get_dsn('dev', 'site_test'),
);

$aliases['staging.site.com'] = array(
  'root' => '/var/www/apps/site/current',
  'remote-host' => 'site',
  'remote-user' => 'webdev',
  'path-aliases' => array(
    '%dump' => '/tmp/site_test.sql',
    '%files' => '/var/www/apps/site/current/sites/site.staging/files',
  ),
  'uri' => 'staging.site.com',
  'databases' => site_get_dsn('site-staging', 'site_test'),
);

$aliases['site.com'] = array(
  'root' => '/var/www/apps/site/current',
  'remote-host' => 'site',
  'remote-user' => 'webdev',
  'path-aliases' => array(
    '%dump' => '/tmp/site_production.sql',
    '%files' => '/var/www/apps/site/current/sites/site.com/files',
  ),
  'uri' => 'masterdigitale.com',
  'databases' => altura_get_dsn('site-production', 'site_production'),
);
