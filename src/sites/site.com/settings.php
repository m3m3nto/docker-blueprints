...
/**
 * @TODO: those settings are dedicated to deployment tests and should be replaced with real informations.
 */
$databases = array (
  'default' => 
  array (
 ...
 *
 */
$drupal_hash_salt = 'IGHASAavdqdlxJHpow9l47323GHTm_3iwPgDYFA_jZzpU';
...
/**
 * Custom Dranswers q-domus.com variable overrides
 *
 */
 ...
 */
$conf['site_name'] = 'sites.com';
$conf['site_slogan'] = '';
$conf['site_frontpage'] = 'node';
$conf['file_directory_temp'] = "sites/site.com/files/tmp";
$conf['file_temporary_path'] = "sites/site.com/files/tmp";
$conf['file_public_path'] = "sites/site.com/files";
$conf['file_private_path'] = "sites/site.com/files/private";
$conf['site_mail'] = "site@site.com";

// Stats count settings
$conf['statistics_count_content_views']= 1;

/* --------- Users and Roles ------------ */
// Allow visitor account creation, without administrative approval.
// 0 = Admin only  1 = Visitors  2 = Visitors with admin approval
$conf['user_register'] = 1;

// This set the stale file threshold; Varnish ttl is set to 21600 seconds, 
// so we set this var to 22600
$conf['drupal_stale_file_threshold'] = 22600;

/**
 * Logging
 */
$conf['error_level'] = 0; // 0 = None  1 = Errors and warnings  2 = All messages
$conf['dblog_row_limit'] = 10000; // Possible values: 100, 1000, 10000, 100000, 1000000
...
$base_url = "https://www.sensibus.com/deli";