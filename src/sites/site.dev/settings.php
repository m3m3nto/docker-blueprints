 ...
 *
 */
$drupal_hash_salt = 'DNuv2dsa4s5GANdasI8gyc_rDKOtreWKQtreGHGV_CaUffRw';
...
/**
 * Common configurations: cannot be overridden
 */  
$conf['site_name'] = 'Sensibus.com - Development';
$conf['site_slogan'] = '';
$conf['site_frontpage'] = 'node';
$conf['file_directory_temp'] = "sites/site.dev/files/tmp";
$conf['file_temporary_path'] = "/tmp";
$conf['file_public_path'] = "sites/site.dev/files";
...
// This set the stale file threshold; in dev env Varnish is not present, 
// so we set this var to default value 2592000 (1 month)
$conf['drupal_stale_file_threshold'] = 2592000;

/**
 * Logging
 */
$conf['error_level'] = 1; // 0 = None  1 = Errors and warnings  2 = All messages
$conf['dblog_row_limit'] = 1000; // Possible values: 100, 1000, 10000, 100000, 1000000 
