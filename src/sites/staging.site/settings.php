 ...
 */
$conf['site_name'] = 'Staging.site.com';
$conf['site_slogan'] = '';
$conf['site_frontpage'] = 'node';
$conf['file_directory_temp'] = "sites/staging.site/files/tmp";
$conf['file_temporary_path'] = "sites/staging.site/files/tmp";
$conf['file_public_path'] = "sites/staging.site/files";
$conf['file_private_path'] = "sites/staging.site/files/private";
$conf['site_mail'] = "admin@site.com";
